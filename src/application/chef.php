...
if (isset ( $_POST ['envoi'] )) {
	...
	$_SESSION ['user']->mailToSansProjets ( $etudiantsSansProjets, $sujet, $message );
}
...
<body class="brown lighten-5">
		...
		<div class="card">
			<div class="row">
				<div class="col s12">
					<a
						class="btn-floating btn-large waves-effect waves-light red arrow-link slide-link">
						<i class="mdi-hardware-keyboard-arrow-down"></i>
					</a>
					<h5>Envoyer un mail aux Sans Projet</h5>
					<p>Saisissez le sujet et le contenu du mail que vous souhaiter
						envoyer au étudiants Sans Projet</p>
				</div>
			</div>
			...
			<form enctype="multipart/form-data" method="post" action="">
				<div class="file-field input-field">
					...
					<div class="btn light-blue darken-2">
						<span>File</span><input type="file" name="fichier_import"/>
					</div>
				</div>
				<div class="">	
