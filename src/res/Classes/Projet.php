...
class Projet extends TableObject {
	...
	public function afficheHtml()
	{
		...
		echo    "<tr>
					<td class='col-xs-1'>
						<input type='hidden' name='voeux_$this->no_projet' value='$this->no_projet'>
						$this->no_projet 
					</td>
					...
					<td class='col-xs-5'>
						<div class='input-group'>
							<input id='voeux_$this->no_projet' type='text' name='priorite_$this->no_projet' value='0' class='form-control' readonly>
